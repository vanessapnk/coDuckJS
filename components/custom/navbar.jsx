import { User, SearchNormal1, GlobalSearch, People, Calendar2 } from "iconsax-react";
                ...
                <div className="h-full  flex gap-2 items-center justify-evenly align-center">
                    ...
                    <Link href={"/groupsList"}>
                        <div className="flex items-center flex-col justify-center cursor-pointer">
                            ...
                            <p className={`${chatActive ? "text-blue-400" : "text-white-400"}`}>Explore</p>
                        </div>
                    </Link>
                    ...
                    <Link href={"/events"}>
                        <div className="flex items-center flex-col justify-center cursor-pointer">
                            <Calendar2 className={`${eventsActive ? "text-blue-400" : "text-white-400"}`} size="24"
